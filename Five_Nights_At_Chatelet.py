...
AmbientLight(color=Vec4(0.005, 0.005, 0.005, 1))

metro_lights = [
    (Vec3(15, 8, 0),    Vec4(0.035, 0.04, 0.04, 1), 8),
    (Vec3(-10, 8, 10),  Vec4(0.025, 0.04, 0.03, 1), 8),
    (Vec3(-30, 8, -8),  Vec4(0.04, 0.02, 0.02, 1), 8),
    (Vec3(0, 8, -20),   Vec4(0.03, 0.035, 0.045, 1), 8),
    (Vec3(30, 8, 15),   Vec4(0.04, 0.04, 0.03, 1), 8),
    (Vec3(-45, 35, 0),  Vec4(0.03, 0.01, 0.01, 1), 10),
    (Vec3(0, 35, 0),    Vec4(0.025, 0.03, 0.04, 1), 10),
]
